    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="event_update.php?id=<?php echo $id?>" method="post">
					  <div class="control-group <?php echo !empty($dateError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input date="event_date" type="text"  placeholder="Date" value="<?php echo !empty($date)?$date:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($timeError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input time="event_time" type="text"  placeholder="Time" value="<?php echo !empty($time)?$time:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($locationError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input location="event_location" type="text"  placeholder="Location" value="<?php echo !empty($location)?$location:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($descriptionError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input description="event_description" type="text"  placeholder="Description" value="<?php echo !empty($description)?$description:'';?>">
